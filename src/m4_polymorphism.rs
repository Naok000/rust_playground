...
mod test {
    ...
    fn tests_poly() {
        ...
        let addr: Address = Address::from_str("0x4De5025AFa40A7b13ef23b6e3a6Bb99b8b580159")
        .unwrap();

        let new_addr: Address = get_ethereum_data(addr);

        assert_eq!(new_addr,Address::from_str("0x4De5025AFa40A7b13ef23b6e3a6Bb99b8b580159").unwrap());
